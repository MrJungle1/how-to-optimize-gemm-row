...
void AddDot1x4( int k, double *a, int lda,  double *b, int ldb, double *c, int ldc )
{
  ...
  for ( p=0; p<k; p+=4 ){
    ...
    c_00_reg += *(a0p_pntr+1) * b_p0_reg;   
    c_10_reg += *(a1p_pntr+1) * b_p0_reg;  
    c_20_reg += *(a2p_pntr+1) * b_p0_reg;   
    c_30_reg += *(a3p_pntr+1) * b_p0_reg;  

    b_p0_reg = B( p+2, 0 );

    c_00_reg += *(a0p_pntr+2) * b_p0_reg;   
    c_10_reg += *(a1p_pntr+2) * b_p0_reg;  
    c_20_reg += *(a2p_pntr+2) * b_p0_reg;   
    c_30_reg += *(a3p_pntr+2) * b_p0_reg;  

    b_p0_reg = B( p+3, 0 );

    c_00_reg += *(a0p_pntr+3) * b_p0_reg;   
    c_10_reg += *(a1p_pntr+3) * b_p0_reg;  
    c_20_reg += *(a2p_pntr+3) * b_p0_reg;   
    c_30_reg += *(a3p_pntr+3) * b_p0_reg;  
